...
import developer.purple.firefly.NodeManagerActivity;
import developer.purple.firefly.listener.DragSource;
import developer.purple.firefly.listener.DropTarget;
...
public class DragLayer extends MyAbsoluteLayout implements DragSource, DropTarget {
    ...
    public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset,
        ...
        v.setX(left);
        v.setY(top);
        ((NodeView) v).updatePosition(left, top);
//        this.updateViewLayout(v, lp);
     ...
     *         the given location. Should return null if btnArrange estimate is found,
    ...
    public void toast(String msg) {
        if (!NodeManagerActivity.Debugging) return;

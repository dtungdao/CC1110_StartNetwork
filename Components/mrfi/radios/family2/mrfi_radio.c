...
void MRFI_Init(void)
{
   ...
   */ 
  //SLEEP &= ~OSC_PD; // comment out due to confliction configuration in "debugging.c" file

  /* wait for high speed crystal to become stable */
  //while(!(SLEEP & XOSC_STB)); // comment out due to confliction configuration in "debugging.c" file

  /* switch from RC oscillator to high speed crystal oscillator */
  //CLKCON &= ~OSC; // comment out due to confliction configuration in "debugging.c" file
  ...
  // add by manual to set Tx power, refer from SmartRF tool
  //PA_TABLE0= 0x12; // -30dBm, minimum
  //PA_TABLE0= 0x60; // 0dBm
  PA_TABLE0= 0xC0; // 10dBm, maximum without PA
